...
void	initialize_door(t_data *data)
{
	...
	data->doors->flag = -1;
	data->doors->count = 0;
	create_struct_files(data, "./textures/Door_4.xpm", &data->doors->sprite[0]);
	create_struct_files(data, "./textures/Door_3.xpm", &data->doors->sprite[1]);
	create_struct_files(data, "./textures/Door_2.xpm", &data->doors->sprite[2]);
	create_struct_files(data, "./textures/Door_1.xpm", &data->doors->sprite[3]);
}
